        ...
        <div className="container-lg container-specialties">
            ...
            <div data-aos="fade-up-left" data-aos-delay="500" data-aos-duration="1000" className="col-12 col-xxl-9 all-logos">
                <div className="col-12 col-md-6 col-logo">
                    <div className="container-logo prominent-logo">
                ...
                <div className="col-12 col-sm-6 col-md-3 col-logo">
                    <div className="container-logo secondary-logo">
                        <img src="img/Logo-5.jpg" alt="Logo3" />
                    </div>
                </div>
                <div className="col-12 col-sm-6 col-md-3 col-logo">
                    <div className="container-logo secondary-logo">
                        <img src="img/Logo-6.jpg" alt="Logo4" /> 
                    </div>
                </div>
                <div className="col-12 col-sm-6 col-md-3 col-logo">
                    <div className="container-logo secondary-logo">
                        <img src="img/Logo-7.png" alt="Logo5" />
                    </div>
                </div>
                <div className="col-12 col-sm-6 col-md-3 col-logo">
                    <div className="container-logo secondary-logo">
                        <img src="img/Logo-8.jpg" alt="Logo6" />
                    </div>
                </div>
            </div>
        </div>

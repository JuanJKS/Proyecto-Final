                ...
                <div data-aos="zoom-in" data-aos-delay="500" data-aos-duration="500" id="carouselExampleIndicators" className="carousel slide carrousel-home" data-bs-ride="carousel">
                    ...
                    <div className="carousel-inner">
                        <div className="carousel-item active">
                            <img src="img/clasesdeapoyo1a.jpg" className="d-block img-carrousel" alt="Foto1"/>
                        </div>
                        <div className="carousel-item">
                            <img src="img/clasesdeapoyo1-1.jpg" className="d-block img-carrousel" alt="Foto2"/>
                        </div>
                        <div className="carousel-item">
                            <img src="img/clasesdeapoyo1b.jpg" className="d-block img-carrousel" alt="Foto3"/>
                        </div>
                    </div>
                ...
                <div data-aos="zoom-in" data-aos-delay="500" data-aos-duration="500" className="container-lg">
                    ...
                    <div className="row row-grid-home">
                        <ColumnaHome
                            ...
                            texto={<Fragment>Amplia disponibilidad y flexibilidad. Tomá las clases como mas te guste y mejor se adapte a tus necesidades y tus tiempos. Ambas modalidades igualmente efectivas, no dudes en probar la modalidad que mas te convenga, <strong>te sorprederás con los resultados!</strong></Fragment>} />   
                        <ColumnaHome
                            icono={<SiGooglemaps />}
                            titulo={<Fragment><h5>Zona Colegiales</h5></Fragment>}
                            texto={<Fragment>Subte línea B y D.<br></br>Colectivos: 19 – 39 – 42 – 44 – 63 – 65 – 76 – 93 – 108 – 112 – 140.<br></br>Tren Urquiza (Estación F. Lacroze).<br></br>Tren Mitre (Estación Colegiales).</Fragment>} />
                    </div>
                </div>
            </div>
        </div>
